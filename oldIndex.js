...
const CloudStore = new (CustomStore(session))();
...
function assignCookie(res, cookieName, data) {
...
function verifyWithPassport(req, res, next) {
...
api.get(endpoint, verifyWithPassport, (req, res) => db.find(req, res));
